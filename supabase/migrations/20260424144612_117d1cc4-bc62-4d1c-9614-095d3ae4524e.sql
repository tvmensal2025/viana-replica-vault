-- Limpar dados da Judite Pereira (5511945744147) para reiniciar cadastro do zero
-- Mantém apenas id, phone_whatsapp, consultant_id e tipo_produto

-- Apagar conversas anteriores
DELETE FROM public.conversations WHERE customer_id = '78ba50f3-9232-4478-bbeb-3320e5b7a0cb';

-- Apagar logs de fases do worker
DELETE FROM public.worker_phase_logs WHERE customer_id = '78ba50f3-9232-4478-bbeb-3320e5b7a0cb';

-- Apagar transições do bot
DELETE FROM public.bot_step_transitions WHERE customer_id = '78ba50f3-9232-4478-bbeb-3320e5b7a0cb';

-- Resetar todos os campos do cadastro
