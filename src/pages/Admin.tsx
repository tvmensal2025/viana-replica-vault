    ...
    try {
      ...
      if (conflictingConsultant) {
        finalLicense = existingConsultant?.license && existingConsultant.license !== normalizedLicense
          ? existingConsultant.license
          : buildFallbackLicense(normalizedLicense, userId);
      ...
      const consultantFields: Database["public"]["Tables"]["consultants"]["Update"] = {
        ...
        cadastro_url: form.cadastro_url,
        igreen_id: form.igreen_id || null,
      ...
      setForm((prev) => ({
        ...prev,
        license: savedConsultant?.license || finalLicense,
      }));
      ...
      toast({
        ...
        ...(licenseAdjusted ? { description: `A licença foi ajustada automaticamente para ${savedConsultant?.license || finalLicense}.` } : {}),
      });
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3 justify-center">
                      {filteredMetrics.customersByStatus.map((s) => {
                        const badgeColors: Record<string, string> = {
                          ...
                          devolutiva: "bg-orange-500/20 text-orange-400",
        ...
        {/* Preview Tab — keep mounted but hidden to avoid iframe reload flicker */}
